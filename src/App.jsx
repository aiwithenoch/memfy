...
function Shell() {
  ...
  return (
    <div className="app">
      ...
      {selectedApp && <ConnectModal app={selectedApp} onClose={() => setSelectedApp(null)} onConfirm={confirmConnection} setToast={setToast} />}
